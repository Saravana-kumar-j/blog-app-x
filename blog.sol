...
// move this code to remix ide(create a contract and copy the above code to the blog.sol in remix ide ) and compile and copy the contract key and ABI to util.js